...
**Předpis objektu je ve třídě** `class()`. Podle tohoto předpisu vytváříme takzvanou instanci, do závorky se dávají případné vstupní parametry. Na PINU 2 máme připojenu LED a chceme s ní pracovat pomocí dostupných metod pro třídu Led? Mikrokontroléru to řekneme takto:
